...
that recognizes ingredients from photos. `Source: backend/package.json:dependencies`
...
|------|---------|---------|--------|
| Framework (NestJS 10) | `@nestjs/common` | `^10.0.0` | `Source: backend/package.json:dependencies` |
| Framework (NestJS 10) | `@nestjs/core` | `^10.0.0` | `Source: backend/package.json:dependencies` |
| HTTP platform (Express) | `@nestjs/platform-express` | `^10.0.0` | `Source: backend/package.json:dependencies` |
| Configuration | `@nestjs/config` | `^3.3.0` | `Source: backend/package.json:dependencies` |
| Persistence (Mongoose 8) | `mongoose` | `^8.8.0` | `Source: backend/package.json:dependencies` |
| Persistence (Mongoose 8) | `@nestjs/mongoose` | `^10.1.0` | `Source: backend/package.json:dependencies` |
| API documentation | `@nestjs/swagger` | `^8.0.1` | `Source: backend/package.json:dependencies` |
| Auth | `@nestjs/jwt` | `^10.2.0` | `Source: backend/package.json:dependencies` |
| Auth | `@nestjs/passport` | `^10.0.3` | `Source: backend/package.json:dependencies` |
| Auth | `passport` | `^0.7.0` | `Source: backend/package.json:dependencies` |
| Auth | `passport-jwt` | `^4.0.1` | `Source: backend/package.json:dependencies` |
| Auth | `passport-anonymous` | `^1.0.1` | `Source: backend/package.json:dependencies` |
| Password hashing | `bcryptjs` | `^2.4.3` | `Source: backend/package.json:dependencies` |
| AI / image recognition | `@google-cloud/vision` | `^4.3.2` | `Source: backend/package.json:dependencies` |
| Validation | `class-validator` | `^0.14.1` | `Source: backend/package.json:dependencies` |
| Validation | `class-transformer` | `^0.5.1` | `Source: backend/package.json:dependencies` |
| Language | `typescript` | `^5.1.3` | `Source: backend/package.json:devDependencies` |
| Build CLI | `@nestjs/cli` | `^10.0.0` | `Source: backend/package.json:devDependencies` |
| Runtime | Node.js | `20` (`node:20-alpine`) | `Source: backend/Dockerfile` |
...
to the package scripts. `Source: backend/package.json:scripts`
...
(preserved quick-start step). `Source: backend/README.md`
...
(preserved from the original setup steps): `Source: backend/README.md`
