...
returns that ingredient record. Source: backend/src/ai/ai.service.ts:L102-L175
...
persisted ingredient records. Source: backend/src/ai/ai.module.ts:L27
...
- `AiModule` (`ai.module.ts`) — the feature composition root. It declares
  ...
  for ingredient lookups. Source: backend/src/ai/ai.module.ts:L27
- `AiController` (`ai.controller.ts`) — a single-route REST controller that exposes
  ...
  Source: backend/src/ai/ai.controller.ts:L26-L43
- `AiService` (`ai.service.ts`) — holds the `ImageAnnotatorClient`, the
  ...
  used for label matching. Source: backend/src/ai/ai.service.ts:L21-L63
...
- `AiModule` is wired into the root `AppModule`. Source: backend/src/app.module.ts:L62
- `AiService` delegates ingredient resolution to
  ...
  Source: backend/src/ai/ai.service.ts:L153-L160
...
matches. Source: backend/src/ai/ai.service.ts:L161-L175
...
Source: backend/src/ai/ai.service.ts:L161-L175
...
- `POST ai/vision` — served under the global `api` prefix as **`POST /api/ai/vision`**.
  ...
  Source: backend/src/ai/ai.controller.ts:L26,L43; prefix
...
- The request is a multipart upload whose file field is named **`image`**, handled by
  ...
  (`10 * 1024 * 1024`). Source: backend/src/ai/ai.controller.ts:L43-L61 (limit at L59)
- When no file is provided, the handler throws
  `BadRequestException('Image empty')`. Source: backend/src/ai/ai.controller.ts:L64-L65
...
- Recognition requires a Google Cloud Vision **service-account key at
  ...
  Source: backend/src/ai/ai.service.ts:L70
- When that key file is absent, `isGoogleVisionEnabled` is set to `false`, which
  ...
  Source: backend/src/ai/ai.service.ts:L73-L76
...
Flow caption — Source: backend/src/ai/ai.service.ts:L102-L175 and
Source: backend/src/ai/ai.controller.ts:L62-L76
...
- **Dependency injection** — `AiService` injects `IngridientService` through its
  ...
  Source: backend/src/ai/ai.service.ts:L67
- **Internal lookup dictionary** — recognized labels are matched against the
  ...
  Source: backend/src/ai/ai.service.ts:L25-L63,L130-L147
...
- **SECURITY NOTE:** `POST /api/ai/vision` has **no JWT guard** — it is
  ...
  `@UseGuards(AuthGuard('jwt'))`). Source: backend/src/ai/ai.controller.ts:L26-L43
...
- **Hardcoded dictionary:** matching relies on an internal `ingredientDictionary` of
  ...
  Source: backend/src/ai/ai.service.ts:L25-L63
