 ...
 *
 * Source: backend/src/session/infrastructure/document/repositories/session.repository.ts:L12-L13
 */
@Injectable()
export class SessionDocumentRepository implements SessionRepository {
   ...
   * Source: backend/src/session/infrastructure/document/repositories/session.repository.ts:L19-L29
   */
  async findOne(
   ...
   * Source: backend/src/session/infrastructure/document/repositories/session.repository.ts:L31-L36
   */
   ...
   * Source: backend/src/session/infrastructure/document/repositories/session.repository.ts:L38-L55
   */
  async softDelete({
    excludeId,
    ...criteria
