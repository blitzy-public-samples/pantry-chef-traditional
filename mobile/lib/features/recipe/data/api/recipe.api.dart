...
/// Dio API client for the backend `/api/recipe` endpoint family.
///
...
class RecipeApi {
  ...
  /// Calls `GET /api/recipe/matches` with `filters.toJson()` as query
  ...
  /// Calls `GET /api/recipe/:id` and returns the single recipe document
  ...
  /// Calls `GET /api/recipe` with `QueryRecipeDto(ids: ids).toJson()` as
