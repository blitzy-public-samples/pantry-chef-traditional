...
(`Source: mobile/lib/env_config.dart:L2`). State management uses the BLoC
...
(`Source: mobile/pubspec.yaml:dependencies,dev_dependencies,environment`).
...
(`Source: mobile/lib/env_config.dart:L1`). Shared infrastructure sits under
...
`core/constants/`
(`Source: mobile/lib/core/utils/, mobile/lib/core/constants/`). Each feature under
...
`runApp` (`Source: mobile/lib/main.dart:L10-L19`). See
...
> `requestHeader: true`
> (`Source: mobile/lib/core/utils/dio_client.dart:L27-L34,L61-L68`). As a
